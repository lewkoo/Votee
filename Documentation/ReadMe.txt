...
4.0 - Running the Application
===============================
To run the current state of the application, the best option is to locate where you saved the project and 
open the following directory: Votee > packages > custom > voteeHome > public > views > index.html
Once you have located the "views" folder, right click (in WebStorm) on index.html and click run, or double click
in the file explorer.
From here you can navigate through the current iteration of the project that is being developed. 