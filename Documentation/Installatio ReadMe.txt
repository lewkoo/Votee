...
4.0 - Running the Application
===============================
Open a terminal and navigate to the folder where the application was checked out to. Make sure you are in the main Votee
directory.
In your terminal window type node server. This will start the server in a production environment.
Open your preferred web browser (Firefox or Chrome preferably) and navigate to http://localhost:3000
