...
gulp.task('test', function() {
    runSequence('startServer', 'runMocha', 'runKarma', 'stopServer');
});

gulp.task('frontEndTests', function() {
    runSequence('startServer', 'runKarma', 'stopServer');
});

gulp.task('backEndTests', function() {
    runSequence('startServer', 'runMocha', 'stopServer');
});
